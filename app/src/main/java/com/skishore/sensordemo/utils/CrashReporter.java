package com.skishore.sensordemo.utils;
...
/**
 * @author S_Kishore since 08/28/2015
 */
public class CrashReporter implements Thread.UncaughtExceptionHandler {
    ...
    private void SendErrorMail(Context _context, String ErrorContent) {
        ...
        sendIntent.putExtra(Intent.EXTRA_EMAIL,
                new String[]{"demomail@dell.com"});
        sendIntent.putExtra(Intent.EXTRA_TEXT, body);
        sendIntent.putExtra(Intent.EXTRA_SUBJECT, subject);
        sendIntent.setType("message/rfc822");
        _context.startActivity(Intent.createChooser(sendIntent, "Choose a sender"));
    }

    private void ShowErrorText(Context _context, String errorContent) {
    ...
    public void CheckErrorAndSendMail(Context _context) {
        ...
        //        ShowErrorText(_context, WholeErrorText);
